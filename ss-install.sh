...
install() {
        ...
        then
                ...
                echo -e "[${red}错误${plain}] ss服务器安装失败，请联系minigeek（https://minigeek.blog.csdn.net）"
                cleanup
                exit 1
        fi
        ...
        echo -e "欢迎访问minigeek   ：\033[41;37m https://minigeek.blog.csdn.net \033[0m"
        get_ss_link
}
...
case $1 in
	-h|h|help )
		...
		;;
	-v|v|version )
		echo 'ss-install Version 1.0, 2018-01-20, Copyright (c) 2018 minigeek'
		exit 0;
		;;
esac
